...
int main() {
    ...
    // Vector3D<uint8_t> stair = readVoxFile("vox_tiles/stairs/stair_left.vox");
    ...
    std::vector<Tile*> tileOptions = tile.getListOfTiles();
    Wave wave{20, 20, 2, tile.getListOfTiles()};
